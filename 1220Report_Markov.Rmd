...
## From S4
a_P["S4", "S4", 6:10] <- 1
# the a_P is the transition for 10 cycles
a_P
```
...
```{r}
## For strategy 1 
## 7 transition probabilities by some parameters
...
We say that the screening strategy will have an influence on the first line of the transition matrix.
