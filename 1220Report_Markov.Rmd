...
### Fill in array
## From S1
a_P["S1", "S1", ]   <- (1-(p_live_cvd+p_live_cvdth+p_live_oth_death))
a_P["S1", "S2", ]  <- p_live_cvd
a_P["S1", "S3", ]   <- p_live_cvdth
a_P["S1", "S4", ]   <- p_live_oth_death
## From S2
a_P["S2", "S1", ] <- 0
a_P["S2", "S2", ] <- p_ccvd_acvd
a_P["S2", "S3", ] <- p_ccvd_cvdth
a_P["S2", "S4", ] <- p_live_oth_death
